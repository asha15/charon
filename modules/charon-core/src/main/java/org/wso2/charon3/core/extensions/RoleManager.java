...
public interface RoleManager {
     ...
     */
    Role createRole(Role role) throws CharonException, ConflictException,
            NotImplementedException, BadRequestException, ForbiddenException;
     ...
     * @throws BadRequestException     BadRequestException.
     */
    void deleteRole(String id) throws NotFoundException, CharonException,
            NotImplementedException, BadRequestException, ForbiddenException;
